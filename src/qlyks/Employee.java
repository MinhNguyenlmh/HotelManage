...
public class Employee extends javax.swing.JFrame {
    ...
    {
        try{
            Con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ksan","root","Huydvs1403");
    ...
    private void EmployeeListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EmployeeListMouseClicked
        ...
        EJob.setSelectedItem(model.getValueAt(MyIndex, 6).toString());
        ESalary.setText(model.getValueAt(MyIndex, 7).toString());
